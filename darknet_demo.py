...
class PoseApp:
    def __init__(self, input_path):
        ...
        self.pose_estimator = PoseEstimator("./pose_estimation/configs/coco/resnet/256x192_res50_lr1e-3_1x-duc.yaml", "./pose_estimation/pretrained_models/fast_421_res50-shuffle_256x192.pth")
        pose_encoder = CocoPoseEncoder()
        pose_names = ["run", "walk", "stand"]
        self.pose_classifier = PoseClassifier("./classification/weight/nn_model.pt", pose_encoder, pose_names, 17)
    ...
    def run(self):
        ...
        while(True):
            ...
            for object_info in app_item.object_infos:
                print("Frame: ", frame_idx, " - Object: ", object_info.track_id, " - Velocity: ", object_info.velocity, " - Pose: ", object_info.pose_name)
            frame_idx += 1
...
if __name__ == "__main__":
    ...
    input_path = "./inputs/many-people.mp4"
